              ...
              <div className="bg-white padding-4 shadow-1">
                <div className="usa-prose">
                  ...
                  <p className="font-body-2xs">
                    ...
                    transmit information classified above the accreditation
                    level of this system. Privacy Act Information: information
                    accessed through this system must be protected in accordance
                    with the Privacy Act of 1974, as amended, and AFI 33-332.
                  </p>
              ...
              <section className="page-login--notice usa-prose text-ink margin-top-10 maxw-tabletx">
                ...
                <ul className="font-body-2xs">
                  ...
                  <li>
                    ...
                    and exported from the AF Portal contains FOUO or Controlled
                    ...
                    contact your functional lead or Information Security
                    Officer.
                  </li>
                  <li>
