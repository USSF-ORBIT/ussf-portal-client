                ...
                <div className="usa-alert usa-alert--info">
                  <div className="usa-alert__body usa-prose">
                    ...
                    <ul className="font-body-2xs">
                      ...
                      <li>
                        NOTICE: There is the potential that information
                        presented and exported from the AF Portal contains FOUO
                        or Controlled Unclassified Information (CUI). It is the
